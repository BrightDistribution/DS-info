...
import {C0,C1,C2,C3,C4,C41,C5,C6,C7,C8,C9,C10,C11,C111,C12,C13,C14,C15,C16,C17,D1,D2,D22,D3,D4,D51,D52,D53,D61,D63,D73,D83,D93,D94,D7,D8,Home,Info} from './pages'
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/C111' element={<C111></C111>}></Route>
