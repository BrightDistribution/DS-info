  ...
  return (
    <div>
      ...
      <div className='flex text-xl border-b-2 border-orange-300'>Pasul 1</div>
        ...
        <p className='warn my-[70px]'>ATENTIE! Aveti nevoie de o telecomanda SAMSUNG.</p>

        <p className='flex xs:max-w-[300px] sm:max-w-[600px] lg:max-w-[1150px] mb-4'>Porniti cu telecomanda ecranul.</p>
        <p className='flex xs:max-w-[300px] sm:max-w-[600px] lg:max-w-[1150px]'>Verificati daca va puteti conecta cu telefonul la reteaua de wi-fi TP-Link_BDA4</p>
