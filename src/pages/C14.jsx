...
function C14() {
  return (
    <div>
      ...
      <div className='flex text-xl border-b-2 border-orange-300'>Pasul 16</div>
        <header className='flex flex-col items-center'>
          <p className="flex justify-center xs:max-w-[300px] sm:max-w-[600px] lg:max-w-[1150px]">Intra in fereastra de Home a ecranului, apasand butonul “HOME” de pe telecomanda.</p>
