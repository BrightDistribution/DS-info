    ...
    <div>
      ...
      <div className='flex text-xl border-b-2 border-orange-300'>Pasul 10</div>
        <header className='flex flex-col items-center'>
          <p className="flex justify-center xs:max-w-[300px] sm:max-w-[600px] lg:max-w-[1150px]">Ecranul trebuie sa arate ca cel de mai jos. Apasati butonul "Next" pentru a trece la pasul urmator</p>
